<script lang="ts">
  ...
  // than as wallpaper. All of it is transforms on layers that are already
...
<div class="sky" class:leaving aria-hidden="true" style="--shift: {shift}; --turn: {turn}deg; --px: {px}; --py: {py};">
