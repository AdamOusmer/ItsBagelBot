<script lang="ts">
  ...
  // The marketing site's nav (web/marketing/src/components/layout/Nav.astro), as it was
...
<style>
  ...
  /* Hamburger (web/marketing/src/components/ui/Hamburger.astro): a 44px circle that
