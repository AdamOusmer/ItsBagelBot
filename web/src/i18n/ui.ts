...
const en = {
  ...
  // Playground simulated chat (client script, passed in via data attribute)
  ...
  'play.rBagel': '@you 🥯 fresh from the oven. warm bagel delivered, zero calories.',
  'play.rSong': "now playing · 'late night lo-fi' · queued for @you",
  'play.rLurk': "@you settled into the lurk. seat's saved, I'll wave when you're back.",
  'play.rHelp': 'try !bagel, !song, !poll or !lurk. everything else is configurable from the dashboard.',
  'play.pollIntro': 'poll is up. chat, vote with 1 or 2.',
  'play.pollQ': 'poll · one more game?',
  'play.pollYes': 'yes',
  'play.pollAlways': 'always',
  'play.spamCaught': '⌁ removed · link spam · 0 viewers saw it',
  'play.quietNote': 'the bot stays quiet unless called. chat is yours.',
  'play.unknownCmd': "@you I don't know {cmd} yet. you could teach it to me from the dashboard in about ten seconds.",
  'play.seed2': 'try typing !bagel',
...
const fr: Partial<Record<UIKey, string>> = {
  ...
  'play.amb4': 'quelqu\'un d\'autre a faim maintenant',
  'play.amb5': 'ce saut était propre',
  'play.amb6': 'le chat défile vite ce soir',
  'play.amb7': 'ok ça c\'était vraiment fluide',
  'play.amb8': 'bonne chance pour la prochaine partie',
  'play.amb9': 'le bot a attrapé ça vite lol',
  'play.rBagel': '@you 🥯 tout droit sorti du four. bagel chaud livré, zéro calorie.',
  'play.rSong': 'en écoute · \'late night lo-fi\' · en file pour @you',
  'play.rLurk': '@you s\'installe en mode lurk. place gardée, je te fais signe à ton retour.',
  'play.rHelp': 'essaie !bagel, !song, !poll ou !lurk. tout le reste se configure depuis le tableau de bord.',
  'play.pollIntro': 'le sondage est lancé. chat, votez avec 1 ou 2.',
  'play.pollQ': 'sondage · encore une partie ?',
  'play.pollYes': 'oui',
  'play.pollAlways': 'toujours',
  'play.spamCaught': '⌁ supprimé · lien de spam · 0 spectateur l\'a vu',
  'play.quietNote': 'le bot reste silencieux tant qu\'on ne l\'appelle pas. le chat est le vôtre.',
  'play.unknownCmd': '@you je ne connais pas encore {cmd}. tu pourrais me l\'apprendre depuis le tableau de bord en une dizaine de secondes.',
  'play.seed2': 'essaie de taper !bagel',
