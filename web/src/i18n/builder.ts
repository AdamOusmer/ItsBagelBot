...
const GAME_STATS: VarDef[] = [
  ...
  v('{fn.kd}', '2.83', { en: 'Fortnite K/D', fr: 'Ratio E/M Fortnite' }, { en: 'Your all-time Fortnite kill/death ratio, the same one !fnstats prints. The rest of the palette comes with it: {fn.wins}, {fn.matches}, {fn.kills}, {fn.winrate}, {fn.player}, and the per-mode {fn.solowins}, {fn.duokd}, {fn.squadmatches} and friends. All-time, not this season, so a sentence you write once stays true. Add a name after a colon for somebody else. Needs the Fortnite module.', fr: 'Votre ratio éliminations/morts Fortnite de toujours, celui qu’affiche !fnstats. Le reste de la palette suit: {fn.wins}, {fn.matches}, {fn.kills}, {fn.winrate}, {fn.player}, et les modes {fn.solowins}, {fn.duokd}, {fn.squadmatches} et compagnie. De toujours, pas de la saison: une phrase écrite une fois reste vraie. Ajoutez un nom après deux-points pour quelqu’un d’autre. Nécessite le module Fortnite.' }),
  v('{cr.pol.trophies}', '2100', { en: 'Clash Royale trophies (PoL)', fr: 'Trophées Clash Royale (VdL)' }, { en: 'Your Path of Legends trophies, the same number !crranked prints, with {cr.pol.league}, {cr.pol.rank} and {cr.pol.besttrophies} beside it. The trophy road is a different count and has its own spellings, {cr.road.trophies} and {cr.road.arena}; the lifetime profile is {cr.level}, {cr.wins}, {cr.winrate}, {cr.clan} and friends. Add a player tag after a colon for somebody else. Needs the Clash Royale module.', fr: 'Vos trophées de la Voie des Légendes, le nombre qu’affiche !crranked, avec {cr.pol.league}, {cr.pol.rank} et {cr.pol.besttrophies} à côté. La route des trophées est un autre compte et a ses propres variables, {cr.road.trophies} et {cr.road.arena}; le profil global donne {cr.level}, {cr.wins}, {cr.winrate}, {cr.clan} et compagnie. Ajoutez un tag de joueur après deux-points pour quelqu’un d’autre. Nécessite le module Clash Royale.' }),
  v('{mcsr.elo}', '1650', { en: 'MCSR Ranked elo', fr: 'Elo MCSR Ranked' }, { en: 'Your MCSR Ranked elo this season, the same one !elo prints, with {mcsr.rank}, {mcsr.wins}, {mcsr.losses}, {mcsr.draws}, {mcsr.matches} and {mcsr.country}. This stream\'s change is {mcsr.session.elochange}, and the last match is {mcsr.last.result}, {mcsr.last.opponent}, {mcsr.last.time} and friends. Add a Minecraft name after a colon for somebody else. Needs the MCSR Ranked module.', fr: 'Votre elo MCSR Ranked de la saison, celui qu’affiche !elo, avec {mcsr.rank}, {mcsr.wins}, {mcsr.losses}, {mcsr.draws}, {mcsr.matches} et {mcsr.country}. L’écart du direct, c’est {mcsr.session.elochange}, et le dernier match donne {mcsr.last.result}, {mcsr.last.opponent}, {mcsr.last.time} et compagnie. Ajoutez un pseudo Minecraft après deux-points pour quelqu’un d’autre. Nécessite le module MCSR Ranked.' }),
  v('{bw.fkdr}', '3.60', { en: 'Bed Wars FKDR', fr: 'FKDR Bed Wars' }, { en: 'Your lifetime final kill/death ratio, the same one !bwstats prints, with {bw.stars}, {bw.wins}, {bw.beds}, {bw.wlr} and the rest. The same numbers for a period are {bw.daily.finals}, {bw.weekly.wins}, {bw.monthly.beds} and friends, and your Urchin overlay score is {urchin.score}. Add a Minecraft name after a colon for somebody else. Needs the Bed Wars module.', fr: 'Votre ratio de kills finaux de toujours, celui qu’affiche !bwstats, avec {bw.stars}, {bw.wins}, {bw.beds}, {bw.wlr} et le reste. Les mêmes chiffres sur une période donnent {bw.daily.finals}, {bw.weekly.wins}, {bw.monthly.beds} et compagnie, et votre score Urchin, c’est {urchin.score}. Ajoutez un pseudo Minecraft après deux-points pour quelqu’un d’autre. Nécessite le module Bed Wars.' }),
];
