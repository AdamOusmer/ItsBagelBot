...
export const SURFACES: SurfaceDef[] = [
  ...
  },
  {
    ...
    vars: [
      ...
      v('{solomatches}', '2400', 'Solo matches', 'Matchs solo', 'Matches played in solos.', 'Matchs joués en solo.'),
      v('{solokd}', '3.2', 'Solo K/D', 'K/D solo', 'Kill/death ratio in solos.', 'Ratio éliminations/morts en solo.'),
      v('{duowins}', '90', 'Duo wins', 'Victoires duo', 'Wins in duos.', 'Victoires en duo.'),
      v('{duomatches}', '1900', 'Duo matches', 'Matchs duo', 'Matches played in duos.', 'Matchs joués en duo.'),
      v('{duokd}', '3.8', 'Duo K/D', 'K/D duo', 'Kill/death ratio in duos.', 'Ratio éliminations/morts en duo.'),
      v('{squadwins}', '91', 'Squad wins', 'Victoires squad', 'Wins in squads.', 'Victoires en squad.'),
      v('{squadmatches}', '1932', 'Squad matches', 'Matchs squad', 'Matches played in squads.', 'Matchs joués en squad.'),
      v('{squadkd}', '4.1', 'Squad K/D', 'K/D squad', 'Kill/death ratio in squads.', 'Ratio éliminations/morts en squad.'),
      ...DYNAMIC,
    ],
  },
  {
