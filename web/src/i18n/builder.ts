...
export const SURFACES: SurfaceDef[] = [
  ...
  },
  {
    id: 'mcsr-lastfort',
    group: { en: 'Game stats', fr: 'Stats de jeu' },
    label: { en: 'MCSR: !lastfort', fr: 'MCSR: !lastfort' },
    dashPath: '/modules/mcsr',
    hint: { en: 'MCSR Ranked module → PaceMan most-recent-fortress-run reply.', fr: 'Module MCSR Ranked → réponse de la dernière run avec forteresse PaceMan.' },
    example: { en: '{player} last fort: nether {nether} · bastion {bastion} · fortress {fortress} · fp {firstportal} · sh {stronghold} · {ago} ago', fr: '{player} dernière forteresse: nether {nether} · bastion {bastion} · forteresse {fortress} · pp {firstportal} · fdf {stronghold} · il y a {ago}' },
    prompt: { en: '!lastfort', fr: '!lastfort' },
    vars: [
      v('{player}', 'Feinberg', { en: 'Player', fr: 'Joueur' }, { en: 'The linked player.', fr: 'Le joueur lié.' }),
      v('{nether}', '1:42', { en: 'Nether', fr: 'Nether' }, { en: 'Nether split for that run.', fr: 'Split Nether de cette run.' }),
      v('{bastion}', '3:55', { en: 'Bastion', fr: 'Bastion' }, { en: 'Bastion split for that run.', fr: 'Split Bastion de cette run.' }),
      v('{fortress}', '7:12', { en: 'Fortress', fr: 'Forteresse' }, { en: 'Fortress split for that run.', fr: 'Split Forteresse de cette run.' }),
      v('{firstportal}', '9:20', { en: 'First portal', fr: '1er portail' }, { en: 'First-portal split for that run.', fr: 'Split du premier portail de cette run.' }),
      v('{stronghold}', '—', { en: 'Stronghold', fr: 'Forteresse de fin' }, { en: 'Stronghold split for that run.', fr: 'Split de la forteresse de fin de cette run.' }),
      v('{end}', '—', { en: 'End', fr: 'End' }, { en: 'End-enter split for that run.', fr: "Split d'entrée dans l'End de cette run." }),
      v('{finish}', '—', { en: 'Finish', fr: 'Fin' }, { en: 'Completion time for that run.', fr: 'Temps de fin de cette run.' }),
      v('{ago}', '12m', { en: 'Ago', fr: 'Il y a' }, { en: 'How long ago that run was.', fr: 'Depuis quand date cette run.' }),
      ...DYNAMIC,
    ],
  },
  {
