...
plain: "Your Twitch handle, chat processed in the moment, aggregated usage stats, and an optional contact email."
---
...
- Chat messages processed in real-time for moderation (not stored permanently)
...
- An optional Govee API key, only if you connect the Govee Lights feature. It lets the bot set your own smart lights when a viewer redeems a channel-points reward. It is encrypted at rest, decrypted only on our servers to send commands to Govee, never shown back to you, and deleted the moment you remove it or disable the integration
