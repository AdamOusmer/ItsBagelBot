...
const strings: GuideStrings = {
    ...
    'meta.card.meta': '17 min · 14 étapes',
    ...
    'meta.minutes': '17 min de lecture',
    ...
    'gamestats.b5.head.0': 'Variable',
    'gamestats.b5.head.1': 'Devient',
    'gamestats.b5.head.2': 'Exemple',
    'gamestats.b5.rows.0.0': '<code>&#123;fn.wins&#125;</code>',
    'gamestats.b5.rows.0.1': 'Vos victoires Fortnite de toujours.',
    'gamestats.b5.rows.0.2': '482',
    'gamestats.b5.rows.1.0': '<code>&#123;fn.kd&#125;</code>',
    'gamestats.b5.rows.1.1': 'Éliminations par mort, sur toute la durée.',
    'gamestats.b5.rows.1.2': '2.83',
    'gamestats.b5.rows.2.0': '<code>&#123;fn.matches&#125;</code>',
    'gamestats.b5.rows.2.1': 'Parties jouées.',
    'gamestats.b5.rows.2.2': '7310',
    'gamestats.b5.rows.3.0': '<code>&#123;fn.player&#125;</code>',
    'gamestats.b5.rows.3.1': 'Le compte concerné par la réponse.',
    'gamestats.b5.rows.3.2': 'bagel_bakery',
    'gamestats.b5.rows.4.0': 'Aussi',
    'gamestats.b5.rows.4.1': "<code>&#123;fn.kills&#125;</code>, <code>&#123;fn.winrate&#125;</code>, <code>&#123;fn.window&#125;</code>, et les mêmes chiffres par mode: <code>&#123;fn.solowins&#125;</code>, <code>&#123;fn.solomatches&#125;</code>, <code>&#123;fn.solokd&#125;</code>, ainsi que les variantes <code>duo</code> et <code>squad</code> des trois.",
    'gamestats.b5.rows.4.2': 'Nécessite le module Fortnite',
    'gamestats.b6.head.0': 'Variable',
    'gamestats.b6.head.1': 'Devient',
    'gamestats.b6.head.2': 'Exemple',
    'gamestats.b6.rows.0.0': '<code>&#123;cr.pol.trophies&#125;</code>',
    'gamestats.b6.rows.0.1': "Les trophées de la Voie des Légendes, avec <code>&#123;cr.pol.league&#125;</code>, <code>&#123;cr.pol.rank&#125;</code>, <code>&#123;cr.pol.besttrophies&#125;</code>, <code>&#123;cr.pol.bestleague&#125;</code>, <code>&#123;cr.pol.bestrank&#125;</code> et la paire <code>prev</code>.",
    'gamestats.b6.rows.0.2': '2100',
    'gamestats.b6.rows.1.0': '<code>&#123;cr.road.trophies&#125;</code>',
    'gamestats.b6.rows.1.1': "Les trophées de la route des trophées, un tout autre compte, avec <code>&#123;cr.road.besttrophies&#125;</code> et <code>&#123;cr.road.arena&#125;</code>.",
    'gamestats.b6.rows.1.2': '9123',
    'gamestats.b6.rows.2.0': '<code>&#123;cr.level&#125;</code>',
    'gamestats.b6.rows.2.1': 'Le niveau de roi, tiré du profil global.',
    'gamestats.b6.rows.2.2': '62',
    'gamestats.b6.rows.3.0': '<code>&#123;cr.clan&#125;</code>',
    'gamestats.b6.rows.3.1': "Votre clan, ou «no clan».",
    'gamestats.b6.rows.3.2': 'Bakery',
    'gamestats.b6.rows.4.0': 'Aussi',
    'gamestats.b6.rows.4.1': "Le reste du profil global: <code>&#123;cr.wins&#125;</code>, <code>&#123;cr.losses&#125;</code>, <code>&#123;cr.draws&#125;</code>, <code>&#123;cr.battles&#125;</code>, <code>&#123;cr.winrate&#125;</code>, <code>&#123;cr.crowns&#125;</code>, <code>&#123;cr.challengemax&#125;</code>, <code>&#123;cr.donations&#125;</code>, <code>&#123;cr.totaldonations&#125;</code>, <code>&#123;cr.favcard&#125;</code>. Chacun des trois groupes a son propre <code>&#123;cr.player&#125;</code> et son <code>&#123;cr.tag&#125;</code>.",
    'gamestats.b6.rows.4.2': 'Nécessite le module Clash Royale',
    'gamestats.b7.head.0': 'Variable',
    'gamestats.b7.head.1': 'Devient',
    'gamestats.b7.head.2': 'Exemple',
    'gamestats.b7.rows.0.0': '<code>&#123;mcsr.elo&#125;</code>',
    'gamestats.b7.rows.0.1': "Votre elo MCSR Ranked de la saison, avec <code>&#123;mcsr.rank&#125;</code>, <code>&#123;mcsr.wins&#125;</code>, <code>&#123;mcsr.losses&#125;</code>, <code>&#123;mcsr.draws&#125;</code>, <code>&#123;mcsr.matches&#125;</code>, <code>&#123;mcsr.country&#125;</code>.",
    'gamestats.b7.rows.0.2': '1650',
    'gamestats.b7.rows.1.0': '<code>&#123;mcsr.session.elochange&#125;</code>',
    'gamestats.b7.rows.1.1': "L'elo gagné ou perdu pendant ce direct, signé, avec <code>&#123;mcsr.session.wins&#125;</code> et le reste du même jeu. Toujours à propos de vous, quoi que vous mettiez après deux-points, car le point de départ est enregistré par direct.",
    'gamestats.b7.rows.1.2': '+34',
    'gamestats.b7.rows.2.0': '<code>&#123;mcsr.last.opponent&#125;</code>',
    'gamestats.b7.rows.2.1': "Contre qui vous avez joué en dernier, avec <code>&#123;mcsr.last.result&#125;</code>, <code>&#123;mcsr.last.time&#125;</code>, <code>&#123;mcsr.last.elochange&#125;</code>, <code>&#123;mcsr.last.seed&#125;</code>, <code>&#123;mcsr.last.structure&#125;</code>, <code>&#123;mcsr.last.ago&#125;</code>.",
    'gamestats.b7.rows.2.2': 'Priffin',
    'gamestats.b7.rows.3.0': '<code>&#123;mcsr.player&#125;</code>',
    'gamestats.b7.rows.3.1': "Le pseudo Minecraft concerné par la réponse. Chacun des trois groupes a le sien.",
    'gamestats.b7.rows.3.2': 'bagel_bakery',
    'gamestats.b7.rows.4.0': 'À noter',
    'gamestats.b7.rows.4.1': "Avant votre premier match du direct il n'y a rien à comparer, et un joueur tout neuf n'a pas de dernier match: ces groupes reviennent vides plutôt qu'à zéro. Donnez-leur une valeur par défaut.",
    'gamestats.b7.rows.4.2': 'Nécessite le module MCSR Ranked',
    'gamestats.b8.head.0': 'Variable',
    'gamestats.b8.head.1': 'Devient',
    'gamestats.b8.head.2': 'Exemple',
    'gamestats.b8.rows.0.0': '<code>&#123;bw.stars&#125;</code>',
    'gamestats.b8.rows.0.1': "Votre niveau d'étoiles Bed Wars, avec le reste du profil global: <code>&#123;bw.wins&#125;</code>, <code>&#123;bw.losses&#125;</code>, <code>&#123;bw.finals&#125;</code>, <code>&#123;bw.finaldeaths&#125;</code>, <code>&#123;bw.beds&#125;</code>, <code>&#123;bw.wlr&#125;</code>, <code>&#123;bw.player&#125;</code>.",
    'gamestats.b8.rows.0.2': '402',
    'gamestats.b8.rows.1.0': '<code>&#123;bw.fkdr&#125;</code>',
    'gamestats.b8.rows.1.1': 'Kills finaux par mort finale, sur toute la durée.',
    'gamestats.b8.rows.1.2': '3.60',
    'gamestats.b8.rows.2.0': '<code>&#123;bw.daily.finals&#125;</code>',
    'gamestats.b8.rows.2.1': "Les mêmes chiffres sur une période: remplacez <code>daily</code> par <code>weekly</code> ou <code>monthly</code>. Chaque période a aussi <code>&#123;bw.daily.games&#125;</code> et <code>&#123;bw.daily.levels&#125;</code>, sans équivalent dans le profil global.",
    'gamestats.b8.rows.2.2': '21',
    'gamestats.b8.rows.3.0': '<code>&#123;urchin.score&#125;</code>',
    'gamestats.b8.rows.3.1': "Votre score de l'overlay Urchin, avec <code>&#123;urchin.mode&#125;</code> et <code>&#123;urchin.tagcount&#125;</code>. Il garde son propre nom car c'est une réputation, pas un chiffre de Bed Wars.",
    'gamestats.b8.rows.3.2': '7.5',
    'gamestats.b8.rows.4.0': 'À noter',
    'gamestats.b8.rows.4.1': "Chacune de ces variables est une question distincte posée à Hypixel ou à Urchin: ne nommez que celles que votre phrase dit vraiment. Toutes viennent du même module Bed Wars.",
    'gamestats.b8.rows.4.2': 'Nécessite le module Bed Wars',
