      ...
      blocks: [
        ...
        },
        {
          ...
          lines: [
            ...
            { who: 'bot', text: '@mod_sam compteur morts créé (toute la chaîne).' },
            { who: 'mod', name: 'mod_sam', text: '!counter add morts 5' },
            { who: 'bot', text: '@mod_sam morts est maintenant à 5.' },
          ],
        },
        {
          kind: 'callout',
      ...
      blocks: [
        ...
        },
        {
          ...
          labels: {
            ...
            chip2: 'par spectateur',
            chip3: 'par commande',
            chip4: 'par spectateur + commande',
            hint: "Avancez-le avec &#123;counter:morts&#125; dans la réponse d'une commande, depuis une récompense de points de chaîne, ou avec !counter add.",
            cancel: 'Annuler',
        ...
        },
        {
          ...
          labels: {
            check: 'Garder un compteur',
            fieldName: 'Nom du compteur',
            nameValue: 'hydratations',
            fieldScope: 'Ce que chaque échange compte',
            scopeValue: 'Par spectateur, par récompense',
            chip1: 'toute la chaîne',
            chip2: 'par spectateur',
            chip3: 'par récompense',
            chip4: 'par spectateur + récompense',
            cancel: 'Annuler',
            save: '✓ Enregistrer',
          },
        },
