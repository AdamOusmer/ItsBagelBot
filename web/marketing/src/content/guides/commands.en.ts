      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ...
            ['<code>&#123;user.id&#125;</code>', "The viewer's Twitch user ID. It never changes, even when they rename themselves.", '48291057'],
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ...
            ['<code>&#123;points.name&#125;</code>', 'Whatever you named your points, so one response reads right whether yours are called points or bagels.', 'bagels'],
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          head: ['Variable', 'Becomes', 'Example'],
          rows: [
            ['<code>&#123;emotes:7tv&#125;</code>', 'Every global 7TV emote code, separated by spaces.', 'PagMan Clap peepoHappy'],
            ['<code>&#123;emotes:bttv&#125;</code>', 'The same for the global BetterTTV codes.', 'KEKW monkaS catJAM'],
            ['<code>&#123;emotes:ffz&#125;</code>', 'The same for the global FrankerFaceZ codes.', 'LUL ZULUL AYAYA'],
