...
function demoDetail(id: string, status: GiveawayDetailWire['status'] = 'drawn'): GiveawayDetailWire {
  const detail: GiveawayDetailWire = {
    ...
    eligible: { eligible: 42, free: 25, premium: 9, subscribers: 8, excluded: 17 }, selectionMethod: 'secure_random_without_replacement', algorithmVersion: 'fisher-yates-v1', poolDigest: 'demo', capabilities: { newAwardsEnabled: true, schedulingEnabled: false, providerMutationsEnabled: false, intervalRuleVerified: false, reason: 'demo pending protection' },
    winners: [
