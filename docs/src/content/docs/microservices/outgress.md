...
Discord go-live and go-offline embeds bind the same `twitch.ingress.event.stream` lane the mod-status re-verify already consumes. They never pass through sesame.
