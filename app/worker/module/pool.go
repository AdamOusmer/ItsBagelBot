...
// GetContext returns a zeroed *Context from the pool, ready to fill.
...
var outPool = sync.Pool{New: func() any { return new(Output) }}

// GetOutput returns a zeroed *Output from the pool, ready to fill.
func GetOutput() *Output {
	o := outPool.Get().(*Output)
	*o = Output{}
	return o
}
