...
func (_q *AdminUserQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *AdminUserQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *AdminUserQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *AdminUserQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *AdminUserQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *AdminUserQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *AdminUserQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(adminuser.Table, adminuser.Columns, sqlgraph.NewFieldSpec(adminuser.FieldID, field.TypeUint64))
	_spec.From = _q.sql
...
func (_q *AdminUserQuery) ForUpdate(opts ...sql.LockOption) *AdminUserQuery {
...
func (_q *AdminUserQuery) ForShare(opts ...sql.LockOption) *AdminUserQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
