...
func (_u *CounterUpdate) SetScope(v string) *CounterUpdate {
	_u.mutation.SetScope(v)
	return _u
}

// SetNillableScope sets the "scope" field if the given value is not nil.
func (_u *CounterUpdate) SetNillableScope(v *string) *CounterUpdate {
	if v != nil {
		_u.SetScope(*v)
	}
	return _u
...
func (_u *CounterUpdate) defaults() error {
	if _, ok := _u.mutation.UpdatedAt(); !ok {
		if counter.UpdateDefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized counter.UpdateDefaultUpdatedAt (forgotten import ent/runtime?)")
		}
...
// SetScope sets the "scope" field.
func (_u *CounterUpdateOne) SetScope(v string) *CounterUpdateOne {
	_u.mutation.SetScope(v)
	return _u
}

// SetNillableScope sets the "scope" field if the given value is not nil.
func (_u *CounterUpdateOne) SetNillableScope(v *string) *CounterUpdateOne {
	if v != nil {
		_u.SetScope(*v)
	}
	return _u
...
// defaults sets the default values of the builder before save.
func (_u *CounterUpdateOne) defaults() error {
	if _, ok := _u.mutation.UpdatedAt(); !ok {
		if counter.UpdateDefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized counter.UpdateDefaultUpdatedAt (forgotten import ent/runtime?)")
		}
