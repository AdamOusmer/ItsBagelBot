...
// (app/outgress/token_lease.go) several times over, so the distributed lock
...
// retry budget. Exported so app/outgress/token_lease.go's mintLeaseTTL can be
...
// package stays free of a Valkey import: app/outgress/main.go builds the real
...
// app/outgress/internal/worker/tokenwarm.go), and before this fix every one
...
// app/outgress/token_lease.go), and holding through persistAttempts retries
...
const (
	...
	// floor mintLeaseTTL (app/outgress/token_lease.go) must clear -- the test
