defmodule Youtube.Api.V3.LiveChatMessageSnippet.TypeWrapper.Type do
  ...
  use Protobuf,
    enum: true,
    full_name: "youtube.api.v3.LiveChatMessageSnippet.TypeWrapper.Type",
...
defmodule Youtube.Api.V3.LiveChatUserBannedMessageDetails.BanTypeWrapper.BanType do
  ...
  use Protobuf,
    enum: true,
    full_name: "youtube.api.v3.LiveChatUserBannedMessageDetails.BanTypeWrapper.BanType",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.LiveChatPollDetails.PollStatusWrapper.PollStatus do
  ...
  use Protobuf,
    enum: true,
    full_name: "youtube.api.v3.LiveChatPollDetails.PollStatusWrapper.PollStatus",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.LiveChatMessageListRequest do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatMessageListRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.LiveChatMessageListResponse do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatMessageListResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.LiveChatMessage do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatMessage",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.LiveChatMessageAuthorDetails do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatMessageAuthorDetails",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.LiveChatMessageSnippet.TypeWrapper do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatMessageSnippet.TypeWrapper",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
end
...
defmodule Youtube.Api.V3.LiveChatMessageSnippet do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatMessageSnippet",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
  ...
  field :gift_details, 34,
    optional: true,
    type: Youtube.Api.V3.LiveChatGiftDetails,
    json_name: "giftDetails",
    oneof: 0
end
...
defmodule Youtube.Api.V3.LiveChatTextMessageDetails do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatTextMessageDetails",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.LiveChatUserBannedMessageDetails.BanTypeWrapper do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatUserBannedMessageDetails.BanTypeWrapper",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
end
...
defmodule Youtube.Api.V3.LiveChatUserBannedMessageDetails do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatUserBannedMessageDetails",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.LiveChatSuperChatDetails do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatSuperChatDetails",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.LiveChatSuperStickerDetails do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatSuperStickerDetails",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.LiveChatFanFundingEventDetails do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatFanFundingEventDetails",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.LiveChatNewSponsorDetails do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatNewSponsorDetails",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.LiveChatMemberMilestoneChatDetails do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatMemberMilestoneChatDetails",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.LiveChatMembershipGiftingDetails do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatMembershipGiftingDetails",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.LiveChatGiftMembershipReceivedDetails do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatGiftMembershipReceivedDetails",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.LiveChatPollDetails.PollMetadata.PollOption do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatPollDetails.PollMetadata.PollOption",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.LiveChatPollDetails.PollMetadata do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatPollDetails.PollMetadata",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.LiveChatPollDetails.PollStatusWrapper do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatPollDetails.PollStatusWrapper",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
end
...
defmodule Youtube.Api.V3.LiveChatPollDetails do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.LiveChatPollDetails",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.LiveChatGiftDetails do
  @moduledoc false

  use Protobuf,
    full_name: "youtube.api.v3.LiveChatGiftDetails",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2

  field :gift_name, 1, optional: true, type: :string, json_name: "giftName"

  field :gift_duration, 2,
    optional: true,
    type: Google.Protobuf.Duration,
    json_name: "giftDuration"

  field :jewels_amount, 3, optional: true, type: :int32, json_name: "jewelsAmount"
  field :gift_url, 4, optional: true, type: :string, json_name: "giftUrl"
  field :alt_text, 5, optional: true, type: :string, json_name: "altText"
  field :language, 6, optional: true, type: :string
  field :has_visual_effect, 7, optional: true, type: :bool, json_name: "hasVisualEffect"
  field :combo_count, 8, optional: true, type: :int32, json_name: "comboCount"
end
...
defmodule Youtube.Api.V3.SuperChatEventSnippet do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.SuperChatEventSnippet",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.SuperStickerMetadata do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.SuperStickerMetadata",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.ChannelProfileDetails do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.ChannelProfileDetails",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
...
defmodule Youtube.Api.V3.PageInfo do
  ...
  use Protobuf,
    full_name: "youtube.api.v3.PageInfo",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto2
