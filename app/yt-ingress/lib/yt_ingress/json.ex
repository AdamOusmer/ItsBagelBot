...
defmodule YtIngress.JSON do
  ...
  # Preserve Jason-compatible wire semantics for optional YouTube fields.
  ...
  # (:unsupported_type). Encode them as ISO 8601 strings — e.g. status events
  # carry `since: DateTime.utc_now()`.
