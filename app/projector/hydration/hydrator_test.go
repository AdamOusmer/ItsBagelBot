...
type fakeStore struct {
	...
	setUser     func(context.Context, uint64, string, bool, bool, time.Duration) error
...
func (s *fakeStore) SetUserWithTTL(ctx context.Context, id uint64, status string, active, banned bool, ttl time.Duration) error {
	return s.setUser(ctx, id, status, active, banned, ttl)
}
...
func TestEnsureAsyncHydratesMissingSectionsWithQueryTTLAndReusesSeed(t *testing.T) {
	...
	store.setUser = func(_ context.Context, _ uint64, _ string, _ bool, _ bool, ttl time.Duration) error {
...
func noOpStore() *fakeStore {
	return &fakeStore{
		...
		setUser: func(context.Context, uint64, string, bool, bool, time.Duration) error { return nil },
		setModules: func(context.Context, uint64, []projection.ModuleView, time.Duration) error {
			return nil
		},
