...
func (_u *TokensUpdate) SetToken(v []byte) *TokensUpdate {
	_u.mutation.SetToken(v)
	return _u
}

// SetRefreshToken sets the "refresh_token" field.
func (_u *TokensUpdate) SetRefreshToken(v []byte) *TokensUpdate {
...
func (_u *TokensUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.RefreshTokenCleared() {
		_spec.ClearField(tokens.FieldRefreshToken, field.TypeBytes)
	}
...
// SetToken sets the "token" field.
func (_u *TokensUpdateOne) SetToken(v []byte) *TokensUpdateOne {
	_u.mutation.SetToken(v)
	return _u
}

// SetRefreshToken sets the "refresh_token" field.
func (_u *TokensUpdateOne) SetRefreshToken(v []byte) *TokensUpdateOne {
	_u.mutation.SetRefreshToken(v)
	return _u
}
