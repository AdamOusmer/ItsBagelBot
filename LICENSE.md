...
NO license is granted to any person or entity to use, copy, modify, distribute, sublicense, sell, or run the software.

### 2. EDUCATIONAL USE ONLY
The source code is published here solely for the following purposes:
* Portfolio display
* Educational review and study
* Verification of authorship

### 3. RESTRICTIONS
For the avoidance of doubt, you are **strictly prohibited** from taking any of the following actions, **without limitation**:
* Running this software in any environment (production, development, or local).
* Using any part of this code in other projects (personal, commercial, or non-profit).
* Hosting, leasing, or selling instances of this software.
