...
/**
 * Builds the console SvelteKit config.
 * @param {{ directives?: Record<string, string[]> }} [options] extra/overriding
 *   CSP directives for this app (e.g. the dashboard's 'frame-src': ['none']).
