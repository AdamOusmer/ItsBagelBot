 ...
 * their own copy of these physics (web/src/script/lightfield.js and
 ...
 *
 * Lives under console/shared rather than a repo-level design/ directory
 * because the console images build with `console/` as their whole context
 * (publish-images.yml); anything above that line is simply not in the image
 * build. web/ and docs/ build from a full checkout and can reach in, which is
 * already how web/ imports rehearsal.ts.
 */
