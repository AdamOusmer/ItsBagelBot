...
func TestPublicHTTPSEgressAllowlist(t *testing.T) {
	...
	wantHTTPS := sorted("commands", "console-admin", "console-dashboard", "dingress-egress", "dingress-gateway", "gossip", "loyalty", "modules", "notifications", "outgress", "projector", "sesame", "transactions", "twitch-ingress", "users")
