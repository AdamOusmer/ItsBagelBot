...
var configReaders = map[string]string{
	...
	"VIPRoleID":          "discord.AutoRolePlan tier roles (roles.go)",
	"SubscriberRoleID":   "discord.AutoRolePlan tier roles (roles.go)",
	"RegularsRoleID":     "discord.AutoRolePlan tier roles (roles.go)",
	"MemberRoleID":       "discord.AutoRolePlan join role (roles.go)",
