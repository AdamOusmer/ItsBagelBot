...
// now owned and generated by the recipes repo).
//
...
// what keeps STREAM.CREATE/UPDATE grants narrow (see nats-auth.conf, now
// owned and generated by the recipes repo).
